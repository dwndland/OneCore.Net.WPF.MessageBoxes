...
## [1.0.3] - 2025-11-08
### Fixed
- Fixed IsCancel buttons not applied correctly.

## [1.0.2] - 2025-11-08
### Added
- Adjusted the default button to be displayed in the windows accent colors.
- Added a IsCancel button handling to the box for escape support.
### Changed
- Set IsDefault also on the default button next to the keyboard focus.
